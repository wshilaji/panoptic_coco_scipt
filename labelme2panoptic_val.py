...
root_dir = 'val_data_annotated'
out_json_dir = 'val2017/annotations'
json_file = 'val_data_annotated'
segmentations_folder = './sample_data/panoptic_examples/'
panoptic_coco_categories = './panoptic_coco_categories.json'
out_dir = 'val2017/images'
out_dir1 = 'val2017/image'
...
def main():
    ...
    out_ann_file = osp.join(out_json_dir, "panoptic_val2017.json")
